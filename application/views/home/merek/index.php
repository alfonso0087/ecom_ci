<div class="col-sm-9 padding-right">
  <div class="features_items">
    <!--features_items-->
    <h2 class="title text-center">Produk <?= $JudulMerek['nama_merek']; ?></h2>
    <?php foreach ($MerekProduk as $MP) : ?>
      <div class="col-sm-4">
        <div class="product-image-wrapper">
          <div class="single-products">
            <div class="productinfo text-center">
              <img src="<?= base_url('asset/BE/dist/img/gambar_produk/') . $MP['gambar']; ?>" />
              <h2>Rp. <?= number_format($MP['harga'], 0, ",", "."); ?></h2>
              <p><?= $MP['deskripsi']; ?></p>
