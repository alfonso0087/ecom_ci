<div class="col-sm-9 padding-right">
  <div class="features_items">
    <!--features_items-->
    <h2 class="title text-center">Daftar Seluruh Produk</h2>
    <?php foreach ($produk as $prod) : ?>
      <div class="col-sm-4">
        <div class="product-image-wrapper">
          <div class="single-products">
            <div class="productinfo text-center">
              <img src="<?= base_url('asset/BE/dist/img/gambar_produk/') . $prod['gambar']; ?>" />
              <h2>Rp. <?= number_format($prod['harga'], 0, ",", "."); ?></h2>
              <p><?= $prod['deskripsi']; ?></p>
            ...
            <div class="product-overlay">
              <div class="overlay-content">
                <h2>Rp. <?= number_format($prod['harga'], 0, ",", "."); ?></h2>
                <p><?= $prod['nama_produk']; ?></p>
                <a href="<?= base_url('cart/addCart/') ?>?id_produk=<?= $prod['id_produk'] ?>&harga=<?= $prod['harga'] ?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
              </div>
            </div>
          </div>
        </div>
